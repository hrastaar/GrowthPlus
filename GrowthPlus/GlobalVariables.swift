...
let technologies: [TechnologyData] = [
    ...
    TechnologyData(technologyName: "Realm.io", imageName: "Realm", description: "Portfolio data and account balances are stored using Realm databases"),
    TechnologyData(technologyName: "Lottie", imageName: "lottie", description: "The beautiful animation views shown throughout the app are powered by Lottie"),
    TechnologyData(technologyName: "IEX Cloud Platform", imageName: "iexcloud", description: "Live stock data is provided by IEXCloud, a financial tools API"),
]
